...
class EmpWage
{
   ...
   public $totalWorkingHours=0;
    ...
    function userInput(){
        ...
        $this->monthlyWage($wagePerHour,$workingDaysPerMonth,$workingHoursPerMonth);
    ...
    function dailyWage($wagePerHour)
    {
        $this->workingHours =  $this->empAttendance();
        $dailyWage = $wagePerHour * $this-> workingHours;
    ...
    function monthlyWage($wagePerHour,$workingDaysPerMonth,$workingHoursPerMonth)
    {
        while($this->totalWorkingHours <= $workingHoursPerMonth &&
            $this->totalWorkingDays < $workingDaysPerMonth
        ){
            $this->totalWorkingDays++;
            echo "Day : " . $this->totalWorkingDays. "\n";
            $dailyWage = $this->dailyWage($wagePerHour);
